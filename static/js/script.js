document.addEventListener("DOMContentLoaded", function () {
    // Exibir/ocultar tabela
    document.getElementById("exibir-carros").addEventListener("click", function(event) {
        event.preventDefault();
        var tabela = document.getElementById("tabelaCarros");
        tabela.style.display = tabela.style.display === "none" ? "block" : "none";
    });

    // Remoção de carros (mantido o método AJAX)
    ...
    // Configura os listeners estáticos (que não dependem da tabela)
    ...
    document.getElementById("formAlterar").addEventListener("submit", async function(event) {
        event.preventDefault();
